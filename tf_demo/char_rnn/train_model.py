...
def main(): 
    ...
    parser.add_argument('--seq_length', type=int, default=100, help='RNN sequence length') 
...
def train(args): 
    ...
    if args.init_from is not None: 
        # check if all necessary files exist assert 
        os.path.isdir(args.init_from)," %s must be a a path" % args.init_from 
